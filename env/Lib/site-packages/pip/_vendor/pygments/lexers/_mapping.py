...
LEXERS = {
    ...
    'DockerLexer': ('pip._vendor.pygments.lexers.configs', 'Docker', ('docker', 'dockerfile'), ('Dockerfile', '*.docker'), ('text/x-dockerfile-confi',)),
    ...
    'KconfigLexer': ('pip._vendor.pygments.lexers.configs', 'Kconfig', ('kconfig', 'menuconfig', 'linux-confi', 'kernel-confi'), ('Kconfig*', '*Config.in*', 'external.in*', 'standard-modules.in'), ('text/x-kconfig',)),
    ...
    'UnixConfigLexer': ('pip._vendor.pygments.lexers.configs', 'Unix/Linux confi files', ('unixconfig', 'linuxconfig'), (), ()),
